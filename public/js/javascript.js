// scripts here:
	...
	// show score as "score/possible score"
		var showScore = "Your Score is: " + calcScore +"/" + questionCounter;
	// if 4/4, "perfect score!"
		if (calcScore === questionCounter) {
			showScore = showScore + "&nbsp; <strong style='color:green;'>Perfect Score! </strong>"
		}else if(calcScore>=3){
			showScore = showScore + "&nbsp; <strong><p style='color:blue;'>You tried but try again maybe you will get all!</p> see the correct answers by the left</strong>"
		}else if(calcScore>=1){
			showScore = showScore + "&nbsp; <strong><p style='color:brown;'>Very poor!</p> see the correct answers here <br /> <<-----|</strong>"
		}else if(calcScore>=0){
			showScore = showScore + "&nbsp; <strong><p style='color:red;'>You failed!</p> see the correct answers here <br /> <<-----|</strong>"
		}
